...
image_dir = '/mnt/d/AI Internship Repo/For Kenz Dataset Sort/Side/Reject'
output_excel = '/mnt/d/AI Internship Repo/15. Sorted by Ratio/Side/Reject/mango_shapes.xlsx'

# Make directories for each category
output_dirs = {
    'Rounded': '/mnt/d/AI Internship Repo/15. Sorted by Ratio/Side/Reject/Rounded',
    'Slightly elongated': '/mnt/d/AI Internship Repo/15. Sorted by Ratio/Side/Reject/Slightly Elongated',
    'Highly elongated': '/mnt/d/AI Internship Repo/15. Sorted by Ratio/Side/Reject/Highly Elongated'
}
