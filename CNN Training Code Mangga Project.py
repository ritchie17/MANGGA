...
def create_output_dir():
    ...
    output_dir = f"Training_run_{current_time}"
...
def split_dataset(dataset, train_split, val_split, test_split):
    #assert train_split + val_split + test_split == 1.0, "Split ratios must add up to 1.0"
...
##############################################################
# Prompt user for the name of the data being trained
...
new_model_name = f"{current_time}_{validation_accuracy}_{test_accuracy}_{data_name}.h5"
